...
from in_out.hdf5datasetgenerator import HDF5DatasetGenerator
from nn.conv.emotionvggnet import EmotionVGGNet
...
#If there is no specific model checkpoit supplied, then initialize
